		...
		<div class="pd-ltr-20">
		 ...
		 <!-- Default Basic Forms Start -->
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add LG Form</h4>
							<p class="mb-30">Fill up the form : </p>
						</div>
						
					</div>
		<form action="ToAddLG" method="POST">
						
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">ID</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgId" name="lgId" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgName" name="lgName"  required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="email" id="lgEmail" name="lgEmail"  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Password</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="password" id="lgPassword" name="lgPassword"  required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="lgQualification" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Year</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="lgYear" required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="lgDiv" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">PRN From :</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="lgPRNFrom" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">PRN To :</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="lgPRNTo" required>
							</div>
						</div>
						<br>
				       <button style="margin-left: 450px;" type="submit" class="btn btn-outline-primary">Add LG</button>
					</form>
