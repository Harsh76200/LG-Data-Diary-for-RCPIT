		...
		<div class="pd-ltr-20">
		    ...
		    <!-- Default Basic Forms Start -->
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">LG Update Form</h4>
							<p class="mb-30">Update Your information: </p>
						</div>
						
					</div>
					
			<form action="ToUpdateLG" method="POST">
						
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="lgName" placeholder="Enter Here" type="search">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Email</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="lgEmail" placeholder="harsh@example.com" type="email">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="lgPassword" placeholder="password" type="password">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Qualification</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="lgQualification" placeholder="M.Tech" type="text">
							</div>
						</div>
						<br>
				       <button style="margin-left: 450px;" type="submit" class="btn btn-outline-primary">Update</button>
					</form>
			<br>
