...
<body>
	...
	<%
		String stuName = (String) request.getAttribute("stuNameKey");
	%>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name"><%= stuName %></span>
					</a>
				...
				<ul id="accordion-menu">
					<li class="dropdown">
						<a class="dropdown-toggle no-arrow" href="LGDashboard">
							<span class="micon dw dw-house-1"></span><span style="font-size: large; font-weight: bold;" class="mtext">Student Dashboard</span>
						</a>
						
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle no-arrow" href="LGupdateStudent">
							<span class="micon dw dw-edit2"></span><span class="mtext">Update My Information</span>
						</a>
					</li>
					<li class="dropdown">
						<a class="dropdown-toggle no-arrow" href="StudentAddParentDetails">
							<span class="micon dw dw-library"></span><span class="mtext">Add Parent Details</span>
						</a>
					</li>
					<li>
						<a  class="dropdown-toggle no-arrow"  href="studentViewSelf">
							<span class="micon dw dw-calendar1"></span><span class="mtext">View My Information</span>
						</a>
					</li>
					...
					<li class="dropdown">
						<a class="dropdown-toggle no-arrow" href="LGview">
							<span class="micon dw dw-right-arrow1"></span><span class="mtext">View My LG</span>
						</a>
						
					</li>
					<li class="dropdown">
						<a  class="dropdown-toggle no-arrow" href="addLeave">
							<span class="micon dw dw-browser2"></span><span class="mtext">Request Leave </span>
						</a>
						
					</li>

					<li class="dropdown">
						<a  class="dropdown-toggle no-arrow" href="viewLeave">
							<span class="micon dw dw-list3"></span><span class="mtext">View Leave Status</span>
						</a>
					</li>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back... <div class="weight-600 font-30 text-blue">Mr.<%= stuName %></div>
