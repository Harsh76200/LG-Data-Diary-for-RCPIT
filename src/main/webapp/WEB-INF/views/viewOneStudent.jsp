		...
		<div class="pd-ltr-20">
			...
			<!-- Export Datatable start -->
				<div class="card-box mb-30">
			     ...
			     <form action="StudentviewForm" method="post">
            <div class="form-group">
                <label for="accNo" style="margin-left: 20px ; font-weight: bold">Enter Your PRN</label>
                <input type="text" class="form-control" style="margin-left: 20px; width: 300px;" name="PRN" placeholder="PRN" required>
            </div>
            <button type="submit" class="btn btn-primary"  style="margin-left: 20px;" onclick="viewOneStudent">View</button>
        </form> 
        <br>
        <%-- Display account details if available --%>
