		...
		<div class="pd-ltr-20">
		 ...
		 <!-- Default Basic Forms Start -->
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add New Notice</h4>
							<p class="mb-30">Fill up the form : </p>
						</div>
						
					</div>
		<form action="afterAddNotice" method="POST">
						
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Notice ID</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" id="lgName" name="noticeId"  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Notice Date</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="date" id="lgName" name="noticeDate"  required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" id="lgEmail" name="noticeTitle"  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Notice Description</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text"  name="noticeDescription" required>
							</div>
						</div>
						
						
						<br>
				       <button style="margin-left: 450px;" type="submit" class="btn btn-outline-primary">Add Notice</button>
					</form>
