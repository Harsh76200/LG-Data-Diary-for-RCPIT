		...
		<div class="pd-ltr-20">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back... <div class="weight-600 font-30 text-blue"><%= lgName %></div>
			...
			<!-- Default Basic Forms Start -->
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Parent Details</h4>
							<p class="mb-30">Fill up the form : </p>
						</div>
						
					</div>
					
		<form action="afterAddParent" method="post">
						
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Parent Mobile Number</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" id="parentMob" name="parentMob" required  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Parent Address</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="parentAddress" name="parentAddress" required>
							</div>
						</div>
					
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Parent Pincode</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  type="text" id="parentPincode" name="parentPincode" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Parent City</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="parentCity" name="parentCity" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Parent Email</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="email" id="parentEmail" name="parentEmail" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Parent Type</label>
							<div class="col-sm-12 col-md-10">
								 <select id="parentType" name="parentType" required style="width: 150px; padding: 5px; border: 1px solid #ccc; border-radius: 3px; font-size: 16px; margin-bottom: 10px;">
						...
						<br>
				       <button style="margin-left: 450px;" type="submit" class="btn btn-outline-primary">Add Parent</button>
					</form>
