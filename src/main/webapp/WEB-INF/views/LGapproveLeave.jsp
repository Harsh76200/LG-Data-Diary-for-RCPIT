...
<%
		List<Leave> list = (List<Leave>) request.getAttribute("leaveListKey");
    ...
    %> 
						<table class="table hover multiple-select-row data-table-export nowrap">
							...
							<tr>
								...
								<th class="text-left">Approve Leave</th>
								<th class="text-left">Disapprove Leave</th>
				  ...
				  <tr>
						...
						<td ><a href="ApproveLeaveMaping/<%=leave.getPRN() %>">Approve</a></td>
						<td><a href="DisApproveLeaveMaping/<%=leave.getPRN() %>">Disapprove</a></td>
