		...
		<div class="pd-ltr-20">
		    ...
		    <!-- Default Basic Forms Start -->
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Update Student Form</h4>
							<p class="mb-30">Update Information: </p>
						</div>
			...
			<form action="ToUpdateStudent" method="POST">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">PRN(Must be same)</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgName" name="PRN"  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Age</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgName" name="stuAge"  required>
							</div>
						</div>
					
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">CGPA</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgEmail" name="stuCgpa"  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Year</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="stuYear" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Division</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="stuDiv" required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Current Address</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgPassword" name="stuAddress"  required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="password" id="lgPassword" name="stuPass"  required>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Mobile Number</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="lgQualification" name="stuMob" required>
							</div>
						</div>
						<br>
				      <button style="margin-left: 550px; size: larger;" type="submit" class="btn btn-primary btn-lg">Update</button>
					</form>
			<br>
