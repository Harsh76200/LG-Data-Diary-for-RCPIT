...
<body>
		...
		<div class="pd-ltr-20">
		 ...
		 <!-- Export Datatable start -->
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">View All LG's</h4>
					</div>
					<div class="pb-20">
					  <br>
			        <%-- Display account details if available --%>
						...
						<table class="table hover multiple-select-row data-table-export nowrap">
							...
							<tr>
								...
								<th class="text-left">PRN From</th>
								<th class="text-left">PRN To</th>
								<th class="text-left">Delete LG</th>
							</tr>
							</thead>
							<tbody>
								
	<%
		List<LG> list = (List<LG>) request.getAttribute("list");
    ...
    %> 
			    ...
			    <tr>
					<td class="text-left"><%=lg.getLgId() %></td>
					<td class="text-left"><%=lg.getLgName() %></td>
					<td class="text-left"><%=lg.getLgEmail() %></td>
					<td class="text-left"><%=lg.getLgQualification() %></td>
					<td class="text-left"><%=lg.getLgYear() %></td>
					<td class="text-left"><%=lg.getLgDiv() %></td>
					<td class="text-left"><%=lg.getLgPRNFrom() %></td>
					<td class="text-left"><%=lg.getLgPRNTo() %></td>
					<td><a href="deleteLg/<%=lg.getLgId()%>">Delete</a></td>
				</tr>
